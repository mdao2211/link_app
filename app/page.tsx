...
export default async function homePage() {
    return (
        <>
            {/* HEADER */}
            <header className="sticky inset-x-0 top-0 z-30 py-2 w-full transition-all bg-gray-300">
                <div className="buttonHidden">
                    <button className="fixed right-3 top-3 z-40 rounded-full p-2 transition-colors duration-200 hover:bg-gray-200 focus:outline-none active:bg-gray-300 lg:hidden">
                        <svg
            ...
            <div className="mx-auto mb-10 mt-12 max-w-md px-2.5 text-center sm:max-w-lg sm:px-0">
                ...
                <h2 className="mt-5 text-gray-600 sm:text-xl">
                    LINK is the open-source link management infrastructure for
